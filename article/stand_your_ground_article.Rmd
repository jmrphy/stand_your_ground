---
title: "A Statistical Analysis of Racism and Sexism in \"Stand Your Ground\" Cases in Florida, 2006-2013"
...
```{r, echo=FALSE, fig.height=8.5, fig.width=7, cache=TRUE, message=FALSE, fig.cap="Probability of Conviction (Y) if Trayvon Martin (X) Had Been White (X1)", warning=FALSE}
plot(s.out.gz)
```

```{r, echo=FALSE, fig.height=8.5, fig.width=7, cache=TRUE, message=FALSE, fig.cap="Probability of Conviction (Y) if Marissa Alexander (X) Was Male (X1)", warning=FALSE}
plot(s.out.ma)
```
